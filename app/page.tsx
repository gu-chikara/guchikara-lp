    ...
    <div style={{ backgroundColor: "#F8F5F0", fontFamily: "sans-serif", color: "#3A3A3A" }}>
      ...
      <section id="about" style={{ backgroundColor: "#ffffff" }}>
        <div style={{ maxWidth: "720px", margin: "0 auto", padding: "80px 20px", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px", textAlign: "left" }}>
            {[
              "やりたいことはある。でも何から始めればいいかわからない",
              "情報は集めた。でも頭の中が整理できていない",
              "動きたい。でも気づいたら1年が過ぎていた",
            ].map((text, i) => (
              <div key={i} style={{
                backgroundColor: "#F8F5F0",
                borderRadius: "12px",
                ...
                <p style={{ fontSize: "15px", color: "#3A3A3A", margin: 0, lineHeight: "1.7" }}>{text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ backgroundColor: "#F8F5F0" }}>
        <div style={{ maxWidth: "640px", margin: "0 auto", padding: "80px 20px", textAlign: "center" }}>
          ...
          <p style={{ fontSize: "15px", color: "#666", lineHeight: "1.9", marginTop: "32px" }}>
      ...
      <section style={{ backgroundColor: "#ffffff" }}>
        <div style={{ maxWidth: "720px", margin: "0 auto", padding: "80px 20px", textAlign: "center" }}>
          ...
          <div style={{ textAlign: "left" }}>
            {[
              { num: "1", title: "吐き出す", desc: "愚痴・モヤモヤをそのまま言葉にする" },
              { num: "2", title: "分解する", desc: "情報と問題を整理する" },
              { num: "3", title: "構造化する", desc: "関係性・優先順位を明確にする" },
              { num: "4", title: "設計する", desc: "方向性・価値・ターゲットを決める" },
              { num: "5", title: "決定する", desc: "次の一手を確定させる" },
            ].map((step, i, arr) => (
              <div key={i} style={{
                display: "flex",
                ...
                <span style={{ fontSize: "1.5rem", fontWeight: "700", color: "#C17A5A", minWidth: "32px", lineHeight: "1.4" }}>
                  {step.num}
                </span>
                <div>
      ...
      <section style={{ backgroundColor: "#3A3A3A" }}>
        <div style={{ maxWidth: "720px", margin: "0 auto", padding: "80px 20px", textAlign: "center" }}>
          ...
          <h2 style={{ fontSize: "1.5rem", fontWeight: "500", color: "#ffffff", marginTop: "16px", marginBottom: 0 }}>
            濱田（仮名）
          </h2>
        ...
        <div style={{ maxWidth: "640px", margin: "0 auto", padding: "80px 20px", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", gap: "24px", justifyContent: "center" }} className="price-cards">
            ...
            <div style={{
              ...
              <p style={{ fontSize: "3rem", fontWeight: "700", color: "#3A3A3A", margin: "0 0 16px", lineHeight: 1 }}>¥0</p>
              <p style={{ fontSize: "14px", color: "#555", marginBottom: "12px" }}>60分・オンライン・完全無料</p>
              <p style={{ fontSize: "13px", color: "#aaa" }}>まずは話してみてください</p>
            </div>
            {/* カード2 */}
            <div style={{
              flex: 1, backgroundColor: "#C17A5A", borderRadius: "16px",
              padding: "40px 32px", textAlign: "left",
            }}>
              <p style={{ fontSize: "13px", color: "#ffffff", fontWeight: "600", marginBottom: "16px" }}>思考整理セッション</p>
              <p style={{ fontSize: "3rem", fontWeight: "700", color: "#ffffff", margin: "0 0 16px", lineHeight: 1 }}>¥8,000</p>
              <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.85)", marginBottom: "12px" }}>60分・オンライン</p>
              <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.7)" }}>セッション後に行動プランをお渡しします</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ── ブロック⑥ CTAセクション ── */}
      <section id="apply" style={{ backgroundColor: "#7A9E87" }}>
        <div style={{ maxWidth: "720px", margin: "0 auto", padding: "80px 20px", textAlign: "center" }}>
          ...
          <a href="https://forms.gle/" style={{
            ...
            backgroundColor: "#ffffff", color: "#C17A5A",
            fontWeight: "700", borderRadius: "40px",
